...
class PharmacyDescriptor extends StatefulWidget {
  final Map<String, dynamic> stationDetails;
  final LatLng initialPosition;
  final LatLng finalPosition;

  const PharmacyDescriptor(
      {super.key,
  ...
  @override
  State<PharmacyDescriptor> createState() => _PharmacyDescriptorState();
}

class _PharmacyDescriptorState extends State<PharmacyDescriptor> {
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              widget.stationDetails['name'] ?? "Pharmacy",
