...
import '../../../consts/AppConts.dart';
  ...
  class BusDescriptor extends StatefulWidget {
    ...
    @override
    State<BusDescriptor> createState() => _BusDescriptorState();
  }

  class _BusDescriptorState extends State<BusDescriptor> {
      ...
      return SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                widget.stationDetails['name'] ?? "Bus Station",
              ...
              ListTile(
                ...
                title: Text(
                  widget.stationDetails['rating']!.toString() + "/5 Rating",
                ),
              ),
              SizedBox(height: 10),
              ListTile(
                ...
                title: Text(
                  widget.stationDetails['formatted_phone_number'] ??
                      "No Phone Number",
                ),
              ),
              ListTile(
                ...
                ListTile(
                  title: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: widget.stationDetails['business_status'] == 'OPERATIONAL'
